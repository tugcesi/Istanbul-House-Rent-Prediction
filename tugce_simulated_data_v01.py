...
kentsel gerçek kalibrasyonu (39 ilçe mahalle bazlı analiz).

Dynamic pricing: ilce_ort × mahalle_katsayi
  Lüks mahalle:     katsayi 1.35–2.20
  Orta mahalle:     katsayi 0.90–1.05
  Ekonomik mahalle: katsayi 0.65–0.80

Soft clamp: MIN_KATSAYI=0.65, MAX_KATSAYI=2.20
std = m2_fiyat × 0.08
"""
...
ILCE_ORT: dict[str, int] = {
    ...
    "Beyoğlu": 492, "Adalar": 445, "Zeytinburnu": 585, "Sarıyer": 590,
...
MAHALLELER: dict[str, dict] = {
    ...
    "Alt-Orta Segment – Batı Avrupa": {
        ...
        # Bayrampaşa ilçe ort: 368 TL/m²
        "Bayrampaşa": {
            "Yıldırım(Bay)":      {"katsayi": 1.32},
            "Yıldırım":           {"katsayi": 1.32},
            "Muratpaşa(Bay)":     {"katsayi": 1.27},
            "Muratpaşa":          {"katsayi": 1.27},
            "Kartaltepe(Bay)":    {"katsayi": 1.22},
            "Yenidoğan(Bay)":     {"katsayi": 1.05},
            "Bayrampaşa Merkez":  {"katsayi": 1.00},
            "Altıntepsi":         {"katsayi": 0.98},
            "Orta(Bay)":          {"katsayi": 0.95},
            "İsmetpaşa(Bay)":     {"katsayi": 0.92},
            "İsmetpaşa":         {"katsayi": 0.92},
            "Terazidere":         {"katsayi": 0.88},
            "Kocatepe(Bay)":      {"katsayi": 0.85},
            "Kocatepe":           {"katsayi": 0.85},
            "Uncubozköy":         {"katsayi": 0.82},
    ...
    "Üst Segment – Boğaz (Anadolu)": {
        ...
        # Beykoz ilçe ort: 398 TL/m²
        "Beykoz": {
            "Anadoluhisarı":      {"katsayi": 1.95},
            "Kanlıca":            {"katsayi": 1.72},
            "Çubuklu":            {"katsayi": 1.67},
            "Paşabahçe":          {"katsayi": 1.37},
            "Beykoz Merkez":      {"katsayi": 1.00},
            "Akbaba":             {"katsayi": 0.95},
            "Çavuşbaşı":          {"katsayi": 0.92},
            "Örnekköy":           {"katsayi": 0.90},
            "Göztepe(Bey)":       {"katsayi": 0.88},
            "Dereseki":           {"katsayi": 0.85},
            "Riva":               {"katsayi": 0.82},
            "Polonezköy":         {"katsayi": 0.80},
            "Alibeyköy(Bey)":     {"katsayi": 0.76},
            "Göllü":              {"katsayi": 0.73},
        ...
        # Adalar ilçe ort: 445 TL/m²
        "Adalar": {
            "Büyükada":           {"katsayi": 2.10},
            "Heybeliada":         {"katsayi": 1.57},
            "Burgazada":          {"katsayi": 1.25},
            "Kınalıada":          {"katsayi": 1.10},
    ...
    "Orta Segment – Anadolu Orta Kuşak": {
        ...
        # Ümraniye ilçe ort: 422 TL/m²
        "Ümraniye": {
            "Ataşehir(Üm)":       {"katsayi": 1.50},
            "Namık Kemal(Üm)":    {"katsayi": 1.37},
            "Namık Kemal":        {"katsayi": 1.37},
            "Ihlamurkuyu":        {"katsayi": 1.37},
            "Site(Üm)":           {"katsayi": 1.12},
            "Site":               {"katsayi": 1.12},
            "Çakmak(Üm)":         {"katsayi": 1.15},
            "Ümraniye Merkez":    {"katsayi": 1.05},
            "Esatpaşa(Üm)":       {"katsayi": 1.00},
            "Alemdağ(Üm)":        {"katsayi": 0.98},
            "Alemdağ":            {"katsayi": 0.98},
            "Yenidoğan(Üm)":      {"katsayi": 0.95},
            "Mustafa Kemal(Üm)":  {"katsayi": 0.92},
            "Aşağı Dudullu":      {"katsayi": 0.90},
            "Dudullu":            {"katsayi": 0.88},
            "Yukarı Dudullu":     {"katsayi": 0.88},
            "Elmalıkent":         {"katsayi": 0.85},
            "Parseller":          {"katsayi": 0.82},
            "Çiftlik(Üm)":        {"katsayi": 0.80},
        ...
        # Çekmeköy ilçe ort: 342 TL/m²
        "Çekmeköy": {
            "Merkez(Çek)":        {"katsayi": 1.32},
            "Hamidiye":           {"katsayi": 1.27},
            "Reşadiye":           {"katsayi": 1.27},
            "Alemdağ(Çek)":       {"katsayi": 1.08},
            "Taşdelen":           {"katsayi": 1.05},
            "Çekmeköy Merkez":    {"katsayi": 1.00},
            "Nişantepe":          {"katsayi": 0.98},
            "Ekşioğlu":           {"katsayi": 0.95},
            "Soğukpınar":         {"katsayi": 0.92},
            "Çatalmeşe(Çek)":     {"katsayi": 0.88},
            "Ömerli(Çek)":        {"katsayi": 0.85},
            "Koçullu":            {"katsayi": 0.82},
            "Balaban":            {"katsayi": 0.78},
            "Mehmet Akif(Çek)":   {"katsayi": 0.85},
            "Hamidiye(Çek)":      {"katsayi": 1.27},
            "Mimar Sinan(Çek)":   {"katsayi": 0.88},
            "Cumhuriyet(Çek)":    {"katsayi": 0.90},
        },
        # Pendik ilçe ort: 385 TL/m²
        "Pendik": {
            "Kurtköy":            {"katsayi": 1.52},
            "Güzelyalı(Pen)":     {"katsayi": 1.40},
            "Yenişehir(Pen)":     {"katsayi": 1.35},
            "İçmeler(Pen)":       {"katsayi": 1.35},
            "Kaynarca":           {"katsayi": 1.22},
            "Pendik Merkez":      {"katsayi": 1.10},
            "Kavakpınar":         {"katsayi": 1.05},
            "Sapanbağları":       {"katsayi": 1.00},
            "Batı(Pen)":          {"katsayi": 0.98},
            "Batı":               {"katsayi": 0.98},
            "Doğu(Pen)":          {"katsayi": 0.95},
            "Yayalar":            {"katsayi": 0.92},
            "Ballıca":            {"katsayi": 0.88},
            "Çamlık(Pen)":        {"katsayi": 0.85},
            "Çamlık":             {"katsayi": 0.85},
            "Kışlak":             {"katsayi": 0.82},
            "Dumlupınar(Pen)":    {"katsayi": 0.80},
    ...
    "Alt-Orta Segment – Anadolu Dış Kuşak": {
        # Tuzla ilçe ort: 358 TL/m²
        "Tuzla": {
            "Aydınlı":            {"katsayi": 1.40},
            "İçmeler(Tuz)":       {"katsayi": 1.37},
            "Mimar Sinan(Tuz)":   {"katsayi": 1.15},
            "Mimar Sinan":        {"katsayi": 1.15},
            "Postane(Tuz)":       {"katsayi": 1.10},
            "Postane":            {"katsayi": 1.10},
            "Tuzla Merkez":       {"katsayi": 1.05},
            "Evliya Çelebi(Tuz)": {"katsayi": 1.00},
            "Cami(Tuz)":          {"katsayi": 0.98},
            "Şifa(Tuz)":          {"katsayi": 0.95},
            "Şifa":               {"katsayi": 0.95},
            "Tepeören":           {"katsayi": 0.90},
            "Orhanlı":            {"katsayi": 0.88},
            "Köseköy":            {"katsayi": 0.85},
            "Ömerli(Tuz)":        {"katsayi": 0.82},
            "Akfırat":            {"katsayi": 0.80},
            "Aydıntepe":          {"katsayi": 1.21},
            "Yayla(Tuz)":         {"katsayi": 0.80},
        },
        # Sultanbeyli ilçe ort: 298 TL/m²
        "Sultanbeyli": {
            "Abdurrahman Gazi":   {"katsayi": 1.22},
            "Fatih(Sul)":         {"katsayi": 1.17},
            "Yavuz Selim(Sul)":   {"katsayi": 1.12},
            "Sultanbeyli Merkez": {"katsayi": 1.00},
            "Sultanbeyli Mrk.":   {"katsayi": 1.00},
            "Mehmet Akif(Sul)":   {"katsayi": 0.98},
            "Mimarsinan(Sul)":    {"katsayi": 0.95},
            "Hasanpaşa(Sul)":     {"katsayi": 0.92},
            "Sarıgazi(Sul)":      {"katsayi": 0.90},
            "Turgut Reis(Sul)":   {"katsayi": 0.88},
            "Turgut Reis":        {"katsayi": 0.88},
            "Battalgazi":         {"katsayi": 0.85},
            "Cumhuriyet(Sul)":    {"katsayi": 0.82},
            "Kurna":              {"katsayi": 0.80},
        ...
        # Sancaktepe ilçe ort: 312 TL/m²
        "Sancaktepe": {
            "Emek(San)":          {"katsayi": 1.35},
            "Emek":               {"katsayi": 1.35},
            "Sarıgazi(San)":      {"katsayi": 1.30},
            "Yenidoğan(San)":     {"katsayi": 1.20},
            "Adnan Kahveci(San)": {"katsayi": 1.08},
            "Sancaktepe Merkez":  {"katsayi": 1.00},
            "Sancaktepe Mrk.":    {"katsayi": 1.00},
            "Eyüp Sultan(San)":   {"katsayi": 0.98},
            "Osmangazi(San)":     {"katsayi": 0.95},
            "Osmangazi":          {"katsayi": 0.95},
            "Fatih(San)":         {"katsayi": 0.90},
            "Mimarsinan(San)":    {"katsayi": 0.95},
            "Hasanpaşa(San)":     {"katsayi": 0.92},
            "Kaynarca(San)":      {"katsayi": 0.88},
            "Yenişehir(San)":     {"katsayi": 0.85},
            "Samandıra":          {"katsayi": 0.82},
            "Hüseyinli":          {"katsayi": 0.80},
            "Hint":               {"katsayi": 0.78},
        ...
        # Şile ilçe ort: 285 TL/m²
        "Şile": {
            "Kumbaba":            {"katsayi": 1.40},
            "Şile Merkez":        {"katsayi": 1.35},
            "Uzunkum":            {"katsayi": 1.25},
            "Balibey":            {"katsayi": 1.15},
            "Ağva":               {"katsayi": 1.17},
            "Çayırbaşı(Şil)":     {"katsayi": 1.00},
            "Hacılı":             {"katsayi": 0.95},
            "Meşrutiyet(Şil)":    {"katsayi": 0.92},
            "Değirmençayırı":     {"katsayi": 0.88},
            "Balören":            {"katsayi": 0.85},
            "Avcıkoru":           {"katsayi": 0.82},
            "Çelebi(Şil)":        {"katsayi": 0.80},
            "Doğancılı":          {"katsayi": 0.78},
            "Kurfallı":           {"katsayi": 0.75},
            "Üvezli":             {"katsayi": 0.73},
...
ILCE_ISTATISTIK: dict[str, dict] = {
    ...
    "Sultanbeyli":    {"m2_kira": 298, "ort_deger": 26198, "amortisman_yil": 16, "getiri": 6.18, "yillik_degisim": 30.48},
    ...
    "Sancaktepe":     {"m2_kira": 312, "ort_deger": 29081, "amortisman_yil": 15, "getiri": 6.74, "yillik_degisim": 31.33},
    ...
    "Tuzla":          {"m2_kira": 358, "ort_deger": 32842, "amortisman_yil": 16, "getiri": 6.25, "yillik_degisim": 23.28},
    "Bayrampaşa":     {"m2_kira": 368, "ort_deger": 30665, "amortisman_yil": 14, "getiri": 6.99, "yillik_degisim": 38.00},
    ...
    "Pendik":         {"m2_kira": 385, "ort_deger": 33000, "amortisman_yil": 16, "getiri": 6.32, "yillik_degisim": 31.99},
    "Beykoz":         {"m2_kira": 398, "ort_deger": 43056, "amortisman_yil": 32, "getiri": 3.10, "yillik_degisim": 29.26},
    "Başakşehir":     {"m2_kira": 357, "ort_deger": 41409, "amortisman_yil": 15, "getiri": 6.46, "yillik_degisim": 33.23},
    "Çekmeköy":       {"m2_kira": 342, "ort_deger": 34951, "amortisman_yil": 14, "getiri": 6.95, "yillik_degisim": 35.49},
    "Küçükçekmece":   {"m2_kira": 367, "ort_deger": 34160, "amortisman_yil": 12, "getiri": 8.10, "yillik_degisim": 45.31},
    "Ümraniye":       {"m2_kira": 422, "ort_deger": 35507, "amortisman_yil": 16, "getiri": 6.41, "yillik_degisim": 30.31},
    "Şile":           {"m2_kira": 285, "ort_deger": 42339, "amortisman_yil": 19, "getiri": 5.23, "yillik_degisim": 25.95},
    ...
    "Adalar":         {"m2_kira": 445, "ort_deger": None, "amortisman_yil": None, "getiri": None, "yillik_degisim": None},
...
def estimate_yapi_yasi_fallback(konum: str, fiyat_str: str, metrekare_str: str) -> str:
    """
    Başlıkta yaş bilgisi yokken: ilçe/mahalle katsayısı ve kira (Fiyat/m²) ile
    beklenen ilçe kira/m² ile karşılaştırarak yaş bandı seçilir.
    """
    data, _, _ = lookup_mahalle(konum or "")
    katsayi = float(data["katsayi"]) if data and "katsayi" in data else 1.0
    katsayi = max(MIN_KATSAYI, min(MAX_KATSAYI, katsayi))
    ilce = _ilce_from_konum(konum or "")
    ilce_ort = float(ILCE_ORT.get(ilce, 370))
    beklenen_m2_kira = ilce_ort * katsayi

    m2 = 90.0
    try:
        ms = str(metrekare_str or "").strip().replace(",", ".")
        if ms:
            num = re.match(r"[\d.]+", ms)
            if num:
                m2 = float(num.group())
    ...
    try:
        fs = re.sub(r"[^\d]", "", str(fiyat_str or ""))
        fiyat = float(fs) if fs else 0.0
    except ValueError:
        fiyat = 0.0

    gercek_m2_kira = (fiyat / m2) if fiyat > 0 else beklenen_m2_kira
    ratio = gercek_m2_kira / max(beklenen_m2_kira, 1.0)
...
def simulate_yapi_yasi(
    ...
    if any(p in b for p in sifir_ifadeleri):
        return "0"
    if re.search(r"\bsıfır\s+(bina|daire|kat|dubleks|dublex)\b", b):
        return "0"

    m = re.search(r"(\d+)\s*yaşında", b)
    if m:
    ...
    m = re.search(
        r"(?:inşaat|insaat)\s*yılı?\s*[:\s]*\s*(19\d{2}|20[0-2]\d)", b, re.IGNORECASE
    )
    if m:
        yil = int(m.group(1))
    ...
    if any(y in b for y in ("2024", "2025", "2026")):
        return "0"

    if (konum and konum.strip()) or (fiyat_str and str(fiyat_str).strip()):
        return estimate_yapi_yasi_fallback(konum, fiyat_str, metrekare_str)
...
def process_row(row: dict, index: int) -> dict:
    ...
    if is_empty(row.get("Yapı Yaşı")):
        row["Yapı Yaşı"] = simulate_yapi_yasi(
            baslik, konum, row.get("Fiyat", ""), row.get("Metrekare", "")
        )
