...
Dynamic pricing: ilce_ort × mahalle_katsayi
  Lüks mahalle:     katsayi 1.20–1.35
  Orta mahalle:     katsayi 0.90–1.05
  Ekonomik mahalle: katsayi 0.85–0.90

Soft clamp: MIN_KATSAYI=0.85, MAX_KATSAYI=1.35
...
MAHALLELER: dict[str, dict] = {
    ...
    "Üst Segment – Boğaz (Avrupa)": {
        ...
        "Beşiktaş": {
            "Bebek":              {"katsayi": 1.35},
            "Arnavutköy(Beş)":    {"katsayi": 1.35},
            "Etiler":             {"katsayi": 1.35},
            "Nisbetiye":          {"katsayi": 1.35},
            "Akat":               {"katsayi": 1.35},
            "Ulus":               {"katsayi": 1.35},
            ...
            "Türkali":            {"katsayi": 1.35},  # Akaretler bölgesi
            "Sinanpaşa":          {"katsayi": 1.15},
            "Balmumcu":           {"katsayi": 1.00},
            "Beşiktaş Merkez":    {"katsayi": 0.85},
            "Dikilitaş":          {"katsayi": 0.85},
            "Yıldız":             {"katsayi": 1.12},
    ...
    "Üst-Orta Segment – Merkez Avrupa": {
        ...
        "Şişli": {
            "Nişantaşı":          {"katsayi": 1.35},
            "Teşvikiye":          {"katsayi": 1.35},
            "Harbiye":            {"katsayi": 1.35},
            "Osmanbey":           {"katsayi": 1.35},
            "Cumhuriyet":         {"katsayi": 1.35},  # Şişli Cumhuriyet Mah.
            "Fulya":              {"katsayi": 1.24},
            ...
            "Gülbahar":           {"katsayi": 0.85},
            "İnönü(Şişli)":       {"katsayi": 0.95},
            "Kuştepe":            {"katsayi": 0.85},
            "Paşa":               {"katsayi": 1.00},
        },
        # Beyoğlu ilçe ort: 492 TL/m²
        "Beyoğlu": {
            "Cihangir":           {"katsayi": 1.35},
            "Galata":             {"katsayi": 1.35},
            ...
            "Tarlabaşı":          {"katsayi": 0.85},
            "Pürtelaş":           {"katsayi": 0.85},
            "Kaptanpaşa":         {"katsayi": 0.85},
            "Kemankeş":           {"katsayi": 1.20},
            "Örnektepe":          {"katsayi": 0.85},
            "Halıcıoğlu":         {"katsayi": 0.85},
            "Kulaksız":           {"katsayi": 0.85},
        ...
        "Kağıthane": {
            "Seyrantepe":         {"katsayi": 1.35},
            "Çağlayan":           {"katsayi": 1.20},
            "Kağıthane Merkez":   {"katsayi": 1.00},
            "Gültepe":            {"katsayi": 0.85},
            "Hamidiye":           {"katsayi": 0.85},
            "Ortabayır":          {"katsayi": 0.95},
            "Gürsel":             {"katsayi": 0.88},
            "Harmantepe":         {"katsayi": 0.90},
            "Nurtepe":            {"katsayi": 0.85},
            "Şirintepe":          {"katsayi": 0.85},
            "Telsizler":          {"katsayi": 0.85},
            "Yahya Kemal":        {"katsayi": 0.85},
    ...
    "Orta Segment – Tarihi Yarımada": {
        ...
        "Fatih": {
            ...
            "Yedikule":           {"katsayi": 0.85},
            "Silivrikapı":        {"katsayi": 0.85},
        },
    },
    ...
    "Alt-Orta Segment – Batı Avrupa": {
        ...
        "Esenyurt": {
            "Esenyurt Merkez":    {"katsayi": 1.35},
            "Fatih Mah.(Esen)":   {"katsayi": 1.14},
            "Pınar":              {"katsayi": 1.01},
            "Saadetdere":         {"katsayi": 0.88},
            "Mehterçeşme":        {"katsayi": 0.85},
    ...
    "Üst Segment – Boğaz (Anadolu)": {
        ...
        "Üsküdar": {
            "Çengelköy":          {"katsayi": 1.35},
            "Kuzguncuk":          {"katsayi": 1.35},
        ...
        "Beykoz": {
            "Anadoluhisarı":      {"katsayi": 1.35},
            "Kavacık":            {"katsayi": 1.32},
            "Beykoz Merkez":      {"katsayi": 1.01},
            "Paşabahçe":          {"katsayi": 0.87},
            "Çubuklu":            {"katsayi": 0.85},
            "Anadolu Kavağı":     {"katsayi": 0.85},
    ...
    "Üst-Orta Segment – Anadolu Merkez": {
        ...
        "Kadıköy": {
            ...
            "Kadıköy Merkez":     {"katsayi": 0.85},
            "Bostancı":           {"katsayi": 0.85},
        ...
        "Maltepe": {
            "Cevizli":            {"katsayi": 1.35},
            "Bağlarbaşı(Mal)":    {"katsayi": 1.27},
            "Maltepe Merkez":     {"katsayi": 1.11},
            "Altayçeşme":         {"katsayi": 1.00},
            "Büyükbakkalköy":     {"katsayi": 0.85},
            "Aydınevler":         {"katsayi": 0.85},
            "Zümrütevler":        {"katsayi": 0.90},
            "Feyzullah":          {"katsayi": 0.85},
            "Gülsuyu":            {"katsayi": 0.85},
            "Gülensu":            {"katsayi": 0.85},
            "Başıbüyük":          {"katsayi": 0.85},
            "İdealtepe":          {"katsayi": 0.95},
            "Girne":              {"katsayi": 0.88},
            "Fındıklı(Mal)":      {"katsayi": 0.85},
        },
    },
    ...
    "Orta Segment – Anadolu Orta Kuşak": {
        ...
        "Pendik": {
            ...
            "Dolayoba":           {"katsayi": 0.85},
            "Çamlık":             {"katsayi": 0.92},
            "Velibaba":           {"katsayi": 0.88},
            "Güllü Bağlar":       {"katsayi": 0.85},
            "Esenler(Pen)":       {"katsayi": 0.85},
            "Bahçelievler(Pen)":  {"katsayi": 0.85},
            "Dumlupınar(Pen)":    {"katsayi": 0.85},
            "Batı":               {"katsayi": 0.90},
            "Kavakpınar":         {"katsayi": 0.85},
            "Sapanbağları":       {"katsayi": 0.85},
            "Ertuğrul Gazi":      {"katsayi": 0.85},
            "Yayalar":            {"katsayi": 0.85},
            "Ahmet Yesevi":       {"katsayi": 0.85},
...
TIER_FALLBACK = {
    "üst":      {"katsayi": 1.25},
    "üst-orta": {"katsayi": 1.10},
    "orta":     {"katsayi": 1.00},
    "alt-orta": {"katsayi": 0.92},
    "alt":      {"katsayi": 0.87},
}
...
def simulate_fiyat(baslik: str, oda: str, konum: str, metrekare: str = "") -> str:
    ...
    # 7. Minimum fiyat: İstanbul'da 18.000 TL altı kira yok (2026)
    fiyat = max(18000, fiyat)
